...
import ExtensionTest from './pages/tests/ExtensionTest';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/test/extension" element={session ? <ExtensionTest /> : <Navigate to="/login" replace />} />
        ...
        {/* Remaining movements (IR, ER, …) until they get dedicated pages */}
