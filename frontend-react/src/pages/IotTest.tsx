...
export default function IotTest() {
    ...
    const handleFinish = () => {
        // Logic to save test optionally, for now just go back home
        navigate('/');
    };
    ...
    return (
        <div className="dashboard-container">
            <div className="dashboard-ui">
                <h2>{testId ? testId.replace('-', ' ').toUpperCase() : 'IMU LIVE TELEMETRY'}</h2>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    <button onClick={handleBack} className="test-btn-dash back-btn">BACK</button>
                    <button onClick={handleFinish} className="test-btn-dash finish-btn">FINISH EXAM</button>
                </div>
            </div>
